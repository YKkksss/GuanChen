...
> 实施状态（2026-08-29）：M9-0 至 M9-3 已完成。当前已具备确定性四柱基础、SQLite v23 出生档案与多版本命盘、SQLite v24 独立八字会话、SQLite v25 旺衰格局用神证据版本、无伪精确分数的旺衰证据审计、月令格局候选、四类取用方法隔离、结构冲合复核、未知时辰降级、证据 Context Builder 和独立聊天工作台。下一阶段进入 M9-4 大运确定性排盘；大运算法与公开案例测试完成前，流年和具体事件仍不开放。
