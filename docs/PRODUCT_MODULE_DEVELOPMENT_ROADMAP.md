...
> 实施状态（2026-08-23）：M8-0、M8-1 已完成。当前已具备 SQLite v21 提醒规则与实例、五类提醒规则、流年和大限两种运限配置、IANA 时区换算、幂等实例生成、到期计算、完成/忽略状态流转、关联校验、服务端 CRUD、本地提醒中心、首页到期徽标、规则管理和实例处理。下一步进入 M8-2 月度复盘工作流。
