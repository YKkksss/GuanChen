...
> 实施状态（2026-08-29）：M9-0 至 M9-9 已完成。当前已具备确定性四柱基础、SQLite v23 至 v31 的出生档案、会话、解释证据、大运、流年、关系条件、动态十神和显隐重复版本；已完成跨运双片段、流年与大运表层／藏干十神、原局柱位指向、同干／同十神重复簇、日主参照隔离、四类显隐位置模式及 M9-6 精确表层连接。重复次数严格只表示位置数量，显隐同见不等于透干、通根、引动或力量增强。下一阶段进入 M9-10 透干与通根条件证据审计；当前仍不开放大运吉凶、流年吉凶和具体事件预测。
