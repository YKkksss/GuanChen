...
> 实施状态（2026-08-29）：M9-0 至 M9-6 已完成。当前已具备确定性四柱基础、SQLite v23 至 v28 的出生档案、会话、解释证据、大运、流年和关系审计版本；已完成无伪精确分数的旺衰证据审计、格局候选、取用方法隔离、分钟精度交运、精确立春切年、流年与大运区间求交、年中交运双片段，以及原局—大运—流年的天干生克五合、地支冲合刑害、完整三合三会三刑证据。每条关系保存参与层级、柱位、规则和时间片段，统一禁止自动合化与关系评分。下一阶段进入 M9-7 关系条件与冲突裁决审计；当前仍不开放大运吉凶、流年吉凶和具体事件预测。
