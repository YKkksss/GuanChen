...
> 实施状态（2026-08-29）：M9-0 至 M9-8 已完成。当前已具备确定性四柱基础、SQLite v23 至 v30 的出生档案、会话、解释证据、大运、流年、关系证据、条件冲突和动态十神版本；已完成分钟精度交运、精确立春切年、跨运双片段、跨层干支关系、五合入口条件、关系并见、流年与大运表层／藏干十神，以及只绑定 M9-6 证据的原局柱位指向。藏干严格只记录本气、中气、余气和角色，不宣告透出或引动；方向不等于力量和结果。下一阶段进入 M9-9 岁运十神组合与显隐重复证据审计；当前仍不开放大运吉凶、流年吉凶和具体事件预测。
