  ...
  return (
    <main className="case-form mx-auto min-h-screen max-w-[1180px] px-4 py-7 sm:px-6 sm:py-10">
      <header className="mb-7 flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2"><Link href="/reviews" className="flex items-center gap-2 rounded-lg px-5 py-3 text-xs" style={{ color: 'var(--t-gold)', border: '1px solid var(--t-border-acc)' }}>月度复盘</Link><button type="button" onClick={() => setFormOpen(true)} className="flex items-center gap-2 rounded-lg px-5 py-3 text-xs" style={{ color: '#fff8e8', background: 'linear-gradient(135deg,#9a6210,#c88020)' }}><Plus size={14} />新建提醒</button></div>
      </header>
